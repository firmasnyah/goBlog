...
return[
    ...
    ['label' => 'Dashboard', 'icon' => 'dashboard text-green', 'url' => ['home/dashboard'],
    ...
    ['label'=> 'category', 'icon'=> 'clipboard text-red', 'url'=> ['/category'],
        'visible' => !Yii::$app->user->isGuest
        ],
    ['label'=> 'post', 'icon'=> 'paperclip text-blue', 'url'=> ['/post'],
        'visible' => !Yii::$app->user->isGuest
        ],
    
    ['label' => 'Upload_File', 'icon' => 'file text-blue', 'url' => ['/uploaded-file'],
        'visible' => !Yii::$app->user->isGuest
        ],
